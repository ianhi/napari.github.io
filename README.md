...
For more information about our plans for `napari` you can read our [mission and values statement](https://github.com/napari/napari/blob/master/docs/developers/MISSION_AND_VALUES.md), which includes more details on our vision for supporting a plugin ecosystem around napari.

## contributing

Contributions are encouraged! Please read our [contributing guide](https://github.com/napari/napari/blob/master/docs/developers/CONTRIBUTING.md) to get started. Given that we're in an early stage, you may want to reach out on our [Github Issues](https://github.com/napari/napari/issues) before jumping in.

## code of conduct

`napari` has a [Code of Conduct](https://github.com/napari/napari/blob/master/docs/developers/CODE_OF_CONDUCT.md) that should be honored by everyone who participates in the `napari` community.

## governance

You can learn more about how the `napari` project is organized and managed from our [governance model](https://github.com/napari/napari/blob/master/docs/developers/GOVERNANCE.md), which includes information about, and ways to contact, the [@napari/steering-council](https://github.com/orgs/napari/teams/steering-council) and [@napari/core-devs](https://github.com/orgs/napari/teams/core-devs).
